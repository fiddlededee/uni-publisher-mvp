...
. link:../../example/ps-118/convert-to-pdf.main.kts[example/ps-118/convert-to-pdf.main.kts]
+
[[ps-118]]
Parses html-files and unites them in one book of A4 format (link:../../example/ps-118/output/ps-118.fodt[fodt], link:../../example/ps-118/output/ps-118.pdf[pdf]), and electronic book format (link:../../example/ps-118/output/ps-118-ebook.fodt[fodt], link:../../example/ps-118/output/ps-118-ebook.pdf[pdf]), adjusting formatting for each format
+
...
. link:../../example/builder/table.main.kts[example/builder/table.main.kts]
+
[[from-scratch]]
Builds the letter from json data and converts it to link:../../example/builder/output/letter.fodt[fodt], link:../../example/builder/output/letter.odt[odt], link:../../example/builder/output/letter.pdf[pdf] and link:../../example/builder/output/letter.pdf[docx] formats. Adapted from https://pandoc.org/using-the-pandoc-api.html#builder[Pandoc documentation]
. link:../../example/customize-everything/customize-everything.main.kts[example/customize-everything/customize-everything.main.kts]
+
...
All examples in current project are built with link:../../build-all.sh[build-all.sh]
